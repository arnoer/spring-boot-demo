...
[README.MD](./README-XKCODING.md)    原项目介绍
...
| Module 名称                                                  | Module 介绍                                                  |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| [demo-use-redis](./demo-use-redis)                           | spring-boot 集成 spring-data-redis redisTemplate的使用      |
| [demo-spel-annotation](./demo-spel-annotation)               | spring-boot 使用 spel 表达式，结合AOP 实现注解日志              |
